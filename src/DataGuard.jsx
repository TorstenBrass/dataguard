      ...
      {!usedFree ? (
        ...
        <div style={{textAlign:"left",background:"rgba(0,0,0,0.3)",borderRadius:"16px",padding:"20px",marginTop:"16px"}}>
          ...
          <div style={{borderTop:"1px solid rgba(255,255,255,0.1)",marginTop:"16px",paddingTop:"16px",textAlign:"center"}}>
            ...
            <button onClick={onUnlock} style={{background:"#ef5350",color:"white",border:"none",padding:"12px 24px",borderRadius:"10px",fontWeight:"700",cursor:"pointer",fontSize:"15px"}}>Unlock Full Access — $9</button>
          </div>
        </div>
      ) : null}
    </div>
    ...
    <div style={{minHeight:"100vh",background:"#060610",color:"white",fontFamily:"'Syne', sans-serif",overflowX:"hidden"}}>
      <div style={{position:"relative",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 24px",textAlign:"center",overflow:"hidden"}}>
        ...
        <div style={{position:"relative",zIndex:1,maxWidth:"680px"}}>
          ...
          <p style={{color:"rgba(255,255,255,0.6)",fontSize:"clamp(16px,2vw,19px)",maxWidth:"540px",margin:"0 auto 32px",lineHeight:"1.6"}}>Privacy scores for 48+ apps — built from real data, not marketing claims. See exactly who's harvesting your information and who they're selling it to.</p>
          <div style={{display:"flex",gap:"12px",justifyContent:"center",flexWrap:"wrap",marginBottom:"16px"}}>
            ...
            <button onClick={onPurchase} style={{background:"rgba(255,255,255,0.08)",color:"white",border:"1px solid rgba(255,255,255,0.15)",padding:"14px 28px",borderRadius:"12px",fontSize:"16px",fontWeight:"700",cursor:"pointer",fontFamily:"'Syne', sans-serif"}}>Get Full Access — $9</button>
          </div>
      ...
      <div style={{display:"flex",justifyContent:"center",gap:"40px",flexWrap:"wrap",padding:"32px 24px",borderTop:"1px solid rgba(255,255,255,0.05)",borderBottom:"1px solid rgba(255,255,255,0.05)"}}>
        {[["48+","Apps Analyzed"],["847","Data Brokers Mapped"],["42K+","Community Flags"],["0","Data Points Collected About You"]].map(([num,label])=>(
      ...
      <div style={{maxWidth:"900px",margin:"0 auto",padding:"0 24px 80px"}}>
        ...
        <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:"24px",padding:"40px",display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(160px,1fr))",gap:"32px",textAlign:"center",marginBottom:"64px"}}>
          {[["48+","apps in database"],["18,000+","community reports"],["$0","ad revenue"],["100%","open source"],["0","data points collected about you"]].map(([n,l],i)=>(
        ...
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",zIndex:300,display:"flex",alignItems:"center",justifyContent:"center",padding:"24px",backdropFilter:"blur(8px)"}} onClick={()=>setShowAbout(false)}>
          <div onClick={e=>e.stopPropagation()} style={{background:"#0f0f20",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"24px",padding:"36px",maxWidth:"500px",width:"100%",position:"relative"}}>
            ...
            <div style={{background:"rgba(0,230,118,0.06)",border:"1px solid rgba(0,230,118,0.2)",borderRadius:"14px",padding:"20px",marginBottom:"20px"}}>
              ...
              {["We collect zero user data — no analytics, no logs, no telemetry.","No advertising or sponsored content of any kind.","Your $9 purchase directly funds research and development.","Source code is fully public and auditable on GitHub.","Community contributions are welcome and credited."].map((p,i)=>(
