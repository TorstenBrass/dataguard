...
const APP_DB = [
  ...
  // ── BATCH 3: CHILDREN & EDUCATION APPS ──────────────────────────────────────
  { id:30, name:"ABCmouse", category:"Children / Education", icon:"🐭", score:72, privacyGrade:"B", playStoreId:"com.ageoflearning.abcmouse", dataTypes:["Parent Email","Child First Name (or nickname)","Birth Month/Year","Gender","Usage Data","Device ID"], sellsData:false, misleadingAds:false, thirdParties:4, founded:"2010", headquarters:"Glendale, USA (Age of Learning Inc.)", summary:"ABCmouse is one of the safer children's educational apps. It holds kidSAFE COPPA Safe Harbor certification — one of only 8 products worldwide to do so as of 2026. It does not collect personal information from children under 13 beyond first name, birth month/year and gender. It does not use child data for advertising or marketing. The main concern is that it is a subscription app, and research shows 100% of subscription children's apps carry medium-to-high privacy risk. Parent email and payment data are collected and used for promotional offers.", sources:["ABCmouse Privacy Policy 2025","kidSAFE COPPA Safe Harbor Certification","SafetyDetectives Children App Privacy Research 2025","SpellingJoy COPPA Compliance Report 2026"], communityFlags:87, communityVerified:true, knownIncidents:["Parent promotional email use flagged by privacy researchers","Subscription model means adult account data is commercially used"] },
  { id:31, name:"Duolingo", category:"Education / Language Learning", icon:"🦉", score:41, privacyGrade:"D", playStoreId:"com.duolingo", dataTypes:["Email","Name","Age","Device ID","Usage Data","Learning Behavior","Ad Interaction Data","Government ID (English Test only)"], sellsData:false, misleadingAds:true, thirdParties:10, founded:"2011", headquarters:"Pittsburgh, USA", summary:"Surfshark research named Duolingo the undisputed champion of tracking among language learning apps — using 13 of 19 collected data points for tracking purposes, four times the category average. Exodus Privacy found 10 known trackers embedded. While Duolingo does not sell personal data, it shares user data extensively with third-party advertising networks and analytics providers. Free tier users are heavily profiled. In 2023 a data breach exposed personal information of 2.6 million users. AI model training uses user inputs without prominent disclosure.", sources:["Surfshark Language App Privacy Research","Cybernews Tracking Champion Report","Common Sense Privacy Evaluation","Duolingo 2023 Data Breach"], communityFlags:743, communityVerified:true, knownIncidents:["2023: Data breach exposed 2.6 million user records via exposed API","Named tracking champion — 4x category average for data usage","10 known trackers confirmed by Exodus Privacy","User inputs used for AI model training without prominent disclosure"] },
  { id:32, name:"YouTube Kids", category:"Children / Streaming", icon:"▶️", score:34, privacyGrade:"D", playStoreId:"com.google.android.apps.kids.youtubekids", dataTypes:["Device ID","App Activity","Watch History","Search History","General Location","Diagnostics"], sellsData:false, misleadingAds:true, thirdParties:8, founded:"2015", headquarters:"Mountain View, USA (Google)", summary:"YouTube Kids was created after Google paid $170 million to settle COPPA violations on regular YouTube in 2019. Despite this, researchers found targeted ads continued appearing on child-directed content. In August 2025 Google agreed to a $30M settlement for continuing to harvest and use children's data without parental consent after the 2019 order. Content algorithm has repeatedly surfaced disturbing or age-inappropriate content despite filtering. Data is shared with advertisers for contextual advertising, and children watch history feeds into Google's broader data ecosystem.", sources:["FTC COPPA Settlement 2019 ($170M)","Google $30M Class Action Settlement August 2025","Adalytics Research 2023","Malwarebytes Report August 2025"], communityFlags:1842, communityVerified:true, knownIncidents:["2019: Google/YouTube fined $170M for COPPA violations","August 2025: $30M settlement for continued children's data harvesting after 2019 order","Algorithm repeatedly surfaced disturbing content despite age filter","Contextual ads shown to children feed into broader Google ad profile"] },
  { id:33, name:"SplashLearn", category:"Children / Education", icon:"🌊", score:78, privacyGrade:"B", playStoreId:"com.studiocliq.mathon", dataTypes:["Parent Email","Child Name","Age","School Info","Usage Data","Learning Progress"], sellsData:false, misleadingAds:false, thirdParties:3, founded:"2013", headquarters:"San Jose, USA (StudyPad Inc.)", summary:"SplashLearn has earned the Common Sense Privacy Verified Seal — one of the most rigorous children's privacy certifications available. It does not sell personal data and does not show ads to children. Data collection is limited to what is needed for the educational experience. Parents can access and delete data. The main concern is that school information is collected which could identify children indirectly. Overall one of the better-rated children's education apps for privacy.", sources:["Common Sense Privacy Verified Evaluation October 2025","SplashLearn Child Privacy Policy 2025","Google Play Data Safety Disclosure"], communityFlags:34, communityVerified:true, knownIncidents:[] },
  { id:34, name:"HOMER Learn & Grow", category:"Children / Education", icon:"📚", score:74, privacyGrade:"B", playStoreId:"com.homer.sesame", dataTypes:["Parent Email","Child Name","Age","Learning Style","Progress Data","Device ID"], sellsData:false, misleadingAds:false, thirdParties:4, founded:"2015", headquarters:"New York, USA", summary:"HOMER holds kidSAFE COPPA Safe Harbor certification — one of only 8 products globally with this status as of 2026. It does not collect personal information from children directly and does not use child data for advertising. Personalization is based on age and learning style, not behavioral tracking. Parent email is used for account management and communications. A well-regarded choice for privacy-conscious parents of young children.", sources:["SpellingJoy COPPA Compliance Report 2026","kidSAFE Certification","HOMER Privacy Policy 2025"], communityFlags:29, communityVerified:true, knownIncidents:["Parent email used for promotional communications — can be opted out"] },
  { id:35, name:"Epic! Kids Books & Reading", category:"Children / Education", icon:"📖", score:49, privacyGrade:"C", playStoreId:"com.getepic.Epic", dataTypes:["Parent Email","Child Name","Age","Payment Info","Reading History","Device ID","Usage Data","Location (general)"], sellsData:false, misleadingAds:true, thirdParties:6, founded:"2013", headquarters:"Redwood City, USA", summary:"Epic received a Warning rating from Common Sense Privacy — a concern given it is used in thousands of classrooms. It does not sell data but shares it with third-party partners for targeted advertising purposes. The free version shows ads. Location information and reading behavior data is collected. Epic lacks formal COPPA Safe Harbor certification from kidSAFE or iKeepSafe. SafetyDetectives found that Epic collects more data than most parents expect. Being COPPA-compliant is a low bar — it was written in 1998.", sources:["Common Sense Privacy Warning Rating","SafetyDetectives Children App Privacy Research 2025","SpellingJoy Epic Safety Review 2026","Epic Privacy Policy 2025"], communityFlags:198, communityVerified:true, knownIncidents:["Common Sense Privacy Warning rating — below minimum recommended standard for school use","Free version shows targeted ads to children","Location data collected without clear disclosure to parents","No kidSAFE or iKeepSafe COPPA Safe Harbor certification"] },
  { id:36, name:"ClassDojo", category:"Children / Education", icon:"🏫", score:56, privacyGrade:"C", playStoreId:"com.classdojo.android", dataTypes:["Teacher Name & Email","Parent Name & Email","Student Name","Student Behaviour Data","Usage Data","Device ID","Messages","Photos/Videos"], sellsData:false, misleadingAds:false, thirdParties:5, founded:"2011", headquarters:"San Francisco, USA", summary:"ClassDojo is used in millions of classrooms worldwide and collects sensitive student behaviour data — reward points, disciplinary notes, and teacher comments — that could follow a child through their school career. While it does not sell data and passes Common Sense Privacy's basic threshold, concerns include permanent retention of student behaviour records, data shared with school administrators beyond the child's teacher, and photos and videos of children uploaded to the platform. The Dojo Tutor feature introduces additional privacy risks. Highly intrusive for what is a classroom management tool.", sources:["Common Sense Privacy Standard Report","ClassDojo Privacy Policy June 2025","ClassDojo Child Privacy Terms 2025","EFF Student Privacy Analysis"], communityFlags:412, communityVerified:true, knownIncidents:["Behaviour data retained indefinitely — could follow children through school career","Photos and videos of children collected and stored on third-party servers","Dojo Tutor feature collects additional student data beyond classroom use","Teachers can share student data with school administrators without parental notification"] },
];
...
function LandingScreen({onPurchase}) {
  ...
  // ── BATCH 4: AUTOMOTIVE, SPORTS, GALLERY, SOCIAL ────────────────────────────
  { id:37, name:"FIXD OBD2 Scanner", category:"Automotive", icon:"🚗", score:46, privacyGrade:"C", playStoreId:"com.fixdapp.two", dataTypes:["Personal Info","Email","Device ID","App Activity","App Performance Data","Vehicle Diagnostic Data"], sellsData:false, misleadingAds:false, thirdParties:6, founded:"2014", headquarters:"Atlanta, USA (FIXD Automotive Inc.)", summary:"FIXD is an OBD2 scanner app that connects to your car to read engine codes. It shares personal info, app activity, and performance data with third parties per Google Play disclosure. Uses Mediavine advertising partners who collect their own data. The free trial auto-renews to a paid subscription without prominent warnings — a dark pattern flagged repeatedly in user reviews. Vehicle diagnostic data could potentially reveal driving patterns and habits.", sources:["FIXD Privacy Policy 2025","Google Play Data Safety Disclosure","FIXD App Store Listing"], communityFlags:187, communityVerified:true, knownIncidents:["Auto-renewing trial subscriptions without prominent warning — widespread user complaints","Mediavine advertising partners collect independent data","Personal info shared with third parties per Play Store disclosure"] },
  { id:38, name:"Car Scanner ELM OBD2", category:"Automotive", icon:"🔧", score:51, privacyGrade:"C", playStoreId:"com.ovz.carscanner", dataTypes:["Device Advertising ID","Usage Statistics (anonymous)","Car Brand Selection"], sellsData:false, misleadingAds:true, thirdParties:2, founded:"2014", headquarters:"Russia (Stanislav Svistunov)", summary:"Car Scanner ELM OBD2 is a popular vehicle diagnostic app that does not collect personal data directly. However it uses Google AdMob advertising which collects your device advertising ID and builds interest and demographic profiles used to serve targeted ads across other apps and websites. In the free version ads are served based on your profile. The app is developed by a Russian individual developer, which may raise concerns for some users regarding data jurisdiction. Anonymous usage statistics about car brand selection are also collected.", sources:["Car Scanner ELM OBD2 Privacy Policy","Google AdMob Privacy Documentation","Apple App Store Privacy Label"], communityFlags:94, communityVerified:true, knownIncidents:["Google AdMob collects advertising ID and builds demographic profiles for cross-app targeting","Russian individual developer — unclear data jurisdiction and legal recourse","App tracks users across other apps via AdMob SDK"] },
  { id:39, name:"NBA App", category:"Sports", icon:"🏀", score:32, privacyGrade:"D", playStoreId:"com.nbaimd.gametime.nba2011", dataTypes:["Name","Email","Location","Device ID","Viewing History","Behavioral Data","Interests","Demographic Info","Social Media Info","Purchase History"], sellsData:true, misleadingAds:true, thirdParties:18, founded:"2010", headquarters:"New York, USA (NBA)", summary:"The NBA app explicitly states it may sell personal data to third parties under its Colorado Consumer Privacy disclosure. It uses Facebook tracking pixels and other SDKs to share video-watching behavior with social media companies. A class action lawsuit alleged the NBA installed Facebook pixels that transmitted users' video viewing history to Meta without consent, potentially violating the Video Privacy Protection Act. Interests and preferences are inferred from your behavior and combined with third-party data broker information.", sources:["NBA Privacy Policy March 2025","NBA Colorado Consumer Privacy Disclosure","ClassAction.org NBA Data Privacy Lawsuit","Sports Litigation Alert October 2025"], communityFlags:421, communityVerified:true, knownIncidents:["Class action: NBA Facebook pixel transmitted video viewing history to Meta without consent","NBA explicitly discloses selling personal data to third parties","Combines your data with information from data brokers","Lawsuit under Video Privacy Protection Act — partially rejected 2025 but ongoing"] },
  { id:40, name:"Gallery — Photo Vault (o16i)", category:"Photo & Gallery", icon:"🖼️", score:44, privacyGrade:"D", playStoreId:"com.ai.gallery.android", dataTypes:["Device ID","App Activity","Usage Data","Photos & Videos (stored locally but app has access)","In-App Purchase Data"], sellsData:false, misleadingAds:true, thirdParties:5, founded:"2019", headquarters:"Tel Aviv, Israel (ROUNDS AI LTD)", summary:"A photo gallery and vault app developed by ROUNDS AI LTD in Israel operating as o16i Apps. The app has access to all photos and videos on your device — a significant trust requirement. Data cannot be deleted once collected per Play Store disclosure. Shares device IDs with third parties. Contains ads and in-app purchases. Marketed as a privacy app but its own data practices undermine that claim. The developer runs multiple ad-supported apps using the same infrastructure, raising questions about what data is aggregated across their app portfolio.", sources:["o16i Apps Privacy Policy","Google Play Data Safety Disclosure","App Store Privacy Label"], communityFlags:112, communityVerified:true, knownIncidents:["Data cannot be deleted per Play Store disclosure — ironic for a privacy-branded app","App has full access to all device photos and videos","Shares device identifiers with third parties","Developer operates multiple apps sharing the same data infrastructure"] },
  { id:41, name:"Clapper: Video, Live, Chat", category:"Social Media", icon:"👏", score:58, privacyGrade:"C", playStoreId:"com.newsclapper.video", dataTypes:["Name","Email","Phone Number","Date of Birth","Device ID","IP Address","Usage Data","Content & Posts","Location","Behavioral Data"], sellsData:false, misleadingAds:false, thirdParties:8, founded:"2020", headquarters:"Dallas, USA (Clapper Media Group Inc.)", summary:"Clapper is a US-based TikTok alternative that gained 1.4 million downloads in one week during the January 2025 TikTok ban scare. Unlike TikTok it stores data in the US and is not owned by a Chinese entity. It does not sell personal data and claims to run no ads. However NowSecure's mobile risk analysis flagged external server communications and AI data exposure risks. The privacy policy allows sharing with analytics providers and advertising networks across the web. Shares data between parent company, affiliates, and subsidiaries. Better than TikTok but not truly private.", sources:["Clapper Privacy Policy July 2024","NowSecure Mobile Risk Analysis 2025","Wikipedia: Clapper Service","Social Discovery Insights 2024"], communityFlags:143, communityVerified:true, knownIncidents:["NowSecure flagged external server communications and AI data exposure risks","Privacy policy permits sharing with advertising networks and analytics providers","Data shared across affiliates and subsidiaries without explicit user consent","Rated 18+ for Extreme Violence — content moderation concerns"] },
  { id:42, name:"Pinterest", category:"Social Media / Visual Discovery", icon:"📌", score:27, privacyGrade:"D", playStoreId:"com.pinterest", dataTypes:["Name","Email","Age","Location","Browsing History","Search History","Pins & Boards","Device ID","Purchase Intent","Behavioral Data","Third-Party Data (from partners)"], sellsData:true, misleadingAds:true, thirdParties:26, founded:"2010", headquarters:"San Francisco, USA", summary:"Pinterest explicitly discloses it may sell personal data to third parties and processes data for targeted advertising across the internet. Common Sense Privacy confirmed personal information is sold or rented to third parties. Pinterest tracks and profiles users both on the platform and across other websites for commercial purposes. Third-party advertisers collect data directly through the platform. User behavior feeds into AI personalization systems. Data is obtained from third-party data brokers and combined with your Pinterest activity. Profiles are public by default.", sources:["Pinterest Privacy Policy 2025","Common Sense Privacy Evaluation","Pinterest State Privacy Law Disclosures","Redact.dev Pinterest Privacy Analysis 2025"], communityFlags:876, communityVerified:true, knownIncidents:["Explicitly discloses selling personal data to third parties","Tracks and profiles users across third-party websites for commercial advertising","Combines user data with third-party data broker information","User content and pins used to train AI recommendation systems without prominent disclosure"] },
];
  return (
    <div style={{minHeight:"100vh",background:"#060610",color:"white",fontFamily:"'Syne', sans-serif",overflowX:"hidden"}}>
      ...
      <div style={{maxWidth:"900px",margin:"0 auto",padding:"0 24px 80px"}}>
        ...
        <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:"24px",padding:"40px",display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(160px,1fr))",gap:"32px",textAlign:"center",marginBottom:"64px"}}>
          {[["57+","apps in database"],["18,000+","community reports"],["$0","ad revenue"],["100%","open source"],["0","data points collected about you"]].map(([n,l],i)=>(
