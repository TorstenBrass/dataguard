...
const APP_DB = [
  ...
  { id:11, name:"Granola: AI App Advices", category:"Deceptive Guide App", icon:"⚠️", score:15, privacyGrade:"F", dataTypes:["App Activity","App Info","Device ID","Performance Data"], sellsData:true, misleadingAds:true, thirdParties:8, founded:"2023", headquarters:"Kalimantan Timur, Indonesia", summary:"This is NOT the real Granola AI note-taking app. It is a fake guide app made by an unrelated Indonesian developer deliberately named to impersonate the legitimate Granola AI product. It contains ads, shares app activity and device IDs with third parties, does not encrypt data, and does not allow data deletion.", sources:["Google Play Store listing","Google Play Data Safety disclosure"], communityFlags:47, communityVerified:true, knownIncidents:["Impersonates legitimate Granola AI product","Data not encrypted per Play Store disclosure","Data cannot be deleted per Play Store disclosure","Contains ads despite mimicking a trusted brand"] },
  { id:12, name:"Netflix", category:"Streaming", icon:"🎬", score:42, privacyGrade:"D", dataTypes:["Email Address","Payment Info","Viewing History","Device ID","IP Address","Browsing Behavior","Inferred Interests","Search History"], sellsData:true, misleadingAds:true, thirdParties:15, founded:"1997", headquarters:"Los Gatos, USA", summary:"Collects extensive viewing history, device data, and behavioral patterns to build detailed user profiles. Shares personal information with affiliates, advertising partners and third-party service providers. Cross-references your contact info with third-party databases to target you with ads on other platforms. Better than social media but far from privacy-respecting.", sources:["Netflix Privacy Statement 2024","Common Sense Privacy Report","OpenTermsArchive Netflix Policy"], communityFlags:412, communityVerified:true, knownIncidents:["Shares viewing data with advertising partners","Cross-platform ad targeting using contact matching","Personal information sold to third parties per Common Sense Privacy evaluation"] },
  { id:13, name:"Paramount+", category:"Streaming", icon:"⭐", score:35, privacyGrade:"D", dataTypes:["Precise Geolocation","Viewing History","Device ID","Payment Info","Behavioral Data","Inferred Interests","Demographics","Ad Interactions"], sellsData:true, misleadingAds:true, thirdParties:22, founded:"2021", headquarters:"New York, USA", summary:"Collects precise geolocation, viewing history, and inferred interests to build advertising profiles. Shares this data with advertising partners, measurement companies, and Paramount Global affiliates. Your streaming behavior is actively used to build an ad profile that may be sold to third parties. No specific data retention timelines — your data could be held indefinitely.", sources:["Paramount Privacy Policy 2024","ConductAtlas Data Retention Analysis","Common Sense Privacy Report"], communityFlags:287, communityVerified:true, knownIncidents:["Collects data from children under 13 in child-directed services","Viewing data shared with advertising measurement companies","No clear data retention limits — data held indefinitely"] },
  { id:14, name:"Crave", category:"Streaming", icon:"📺", score:44, privacyGrade:"D", dataTypes:["Email Address","Payment Info","Viewing History","Device ID","Usage Data","Advertising ID"], sellsData:true, misleadingAds:true, thirdParties:12, founded:"2014", headquarters:"Montreal, Canada (Bell Media)", summary:"Crave is Canada's home of HBO, operated by Bell Media. Collects viewing history, device identifiers, and usage data for advertising purposes. Email address used for developer advertising and marketing. As a Bell Media product it falls under Bell's broad data sharing practices across its telecom and media empire. Subscription auto-renews without prominent warnings.", sources:["Crave Google Play Data Safety disclosure","Amazon Appstore Privacy Label","Bell Media Privacy Policy"], communityFlags:156, communityVerified:true, knownIncidents:["Bell Media subject to CRTC data handling scrutiny","Auto-renewal practices flagged by Canadian consumer groups"] },
  { id:15, name:"LinkedIn", category:"Professional Network", icon:"💼", score:29, privacyGrade:"D", dataTypes:["Full Name","Email","Employment History","Location","Device ID","Browsing History","Behavioral Data","Contacts","Browser Extensions (alleged)"], sellsData:false, misleadingAds:true, thirdParties:24, founded:"2003", headquarters:"Sunnyvale, USA (Microsoft)", summary:"Owned by Microsoft, LinkedIn collects extensive professional and behavioral data. Shares data with advertising partners using hashed identifiers. A 2026 investigation alleged LinkedIn scans users browser extensions without disclosure and transmits data to third parties including an American-Israeli cybersecurity firm — described by researchers as one of the largest undisclosed corporate surveillance operations. LinkedIn disputes these claims but the allegations remain under investigation.", sources:["LinkedIn Privacy Policy 2024","Common Sense Privacy Report","BrowserGate Investigation 2026 (CIO/CSO Online)"], communityFlags:891, communityVerified:true, knownIncidents:["2026 BrowserGate allegations: scanning browser extensions without consent","$1.8M FTC settlement for misusing member data for ad targeting (2014)","Used member data for AI training without clear opt-in (2024)"] },
  { id:16, name:"Indeed", category:"Job Search", icon:"🔍", score:52, privacyGrade:"C", dataTypes:["Full Name","Email","Resume Data","Location (GPS)","Employment History","Device ID","Usage Data","Search History"], sellsData:false, misleadingAds:false, thirdParties:14, founded:"2004", headquarters:"Austin, USA (Recruit Holdings)", summary:"Indeed does not sell personal data as defined under CCPA, which is better than most. However it shares resume and application data broadly with employers and affiliates. Collects GPS location data from the mobile app. Shares data for targeted advertising purposes which may qualify as a sale under some state laws. Owned by Japanese conglomerate Recruit Holdings.", sources:["Indeed Privacy Policy 2024","Indeed CCPA Disclosure","Indeed Recruitment Privacy Policy"], communityFlags:203, communityVerified:true, knownIncidents:["Data sharing with employers includes sensitive application materials","Location data collected via GPS without always-clear disclosure","Indeed new data sharing policy raised privacy concerns in 2025"] },
  { id:17, name:"Chicken Run (STEM Studios)", category:"Mobile Game", icon:"🐔", score:38, privacyGrade:"D", dataTypes:["Location","Device ID"], sellsData:false, misleadingAds:true, thirdParties:3, founded:"2019", headquarters:"India (STEM Studios)", summary:"A simple casual mobile game that contains ads and shares location data and device IDs with third parties. Data cannot be deleted once collected. While not as alarming as social media apps, the combination of ads, location sharing, and no data deletion option is concerning for what appears to be a children-friendly game. Last updated in 2019, suggesting limited ongoing privacy maintenance.", sources:["Google Play Data Safety disclosure","Play Store listing"], communityFlags:18, communityVerified:true, knownIncidents:["Location data shared with third parties despite being a simple casual game","Data cannot be deleted per Play Store disclosure","Contains ads in a game rated 12+"] },
  { id:18, name:"Speedtest by Ookla", category:"Network Tools", icon:"⚡", score:33, privacyGrade:"D", dataTypes:["Precise Location","Device ID","Usage Data","User Content","Identifiers","Network Data"], sellsData:true, misleadingAds:true, thirdParties:47, founded:"2006", headquarters:"Seattle, USA (Ziff Davis)", summary:"A seemingly innocent speed testing app that is actually one of the most aggressive trackers in the tools category. Integrates 47 third-party SDKs including advertising and analytics. Tracks users across other apps and websites using location and device identifiers. Owned by Ziff Davis, a large media conglomerate that monetizes network data commercially. Has a Do Not Sell link but opts users in by default.", sources:["Apple App Store Privacy Label","Blankspaces Privacy Report April 2026","Google Play Data Safety disclosure"], communityFlags:634, communityVerified:true, knownIncidents:["47 third-party SDKs embedded — 2 for advertising","Cross-app tracking via location and device identifiers confirmed","Network speed data sold to ISPs and telecom companies","Owned by Ziff Davis which monetizes data across its media portfolio"] },
];
    ...
    <div style={{minHeight:"100vh",background:"#060610",color:"white",fontFamily:"'Syne', sans-serif",overflowX:"hidden"}}>
      ...
      <div style={{maxWidth:"900px",margin:"0 auto",padding:"0 24px 80px"}}>
        ...
        <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:"24px",padding:"40px",display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(160px,1fr))",gap:"32px",textAlign:"center",marginBottom:"64px"}}>
          {[["18+","apps in database"],["18,000+","community reports"],["$0","ad revenue"],["100%","open source"],["0","data points collected about you"]].map(([n,l],i)=>(
...
function MainApp() {
  ...
  const [notifications, setNotifications] = useState([
    ...
    {id:2,app:"LinkedIn",msg:"BrowserGate: alleged undisclosed browser scanning investigation ongoing",time:"1d ago",read:false},
    {id:3,app:"Speedtest by Ookla",msg:"New: 47 embedded third-party SDKs confirmed including 2 ad trackers",time:"2d ago",read:false},
    {id:4,app:"Netflix",msg:"Added to database: shares viewing data with ad partners",time:"3d ago",read:false},
    {id:5,app:"Paramount+",msg:"Added to database: collects precise location, no data retention limits",time:"3d ago",read:false},
  ]);
