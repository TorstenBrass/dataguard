...
const APP_DB = [
  ...
  // ── PASTE YOUR REMAINING APP_DB ENTRIES HERE (batch 2 onward) ───────────────
  // The entries from id:24 through id:224 go here exactly as they are in your
  // current file. Nothing about those entries needs to change — only the
  // category filter system above is new.
];
